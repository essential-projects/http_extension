define(["require", "exports", "@process-engine-js/http_node", "@process-engine-js/core_contracts", "@process-engine-js/utils", "bluebird", "connect-busboy", "compression", "body-parser", "cookie-parser", "helmet", "debug", "http", "cors"], function (require, exports, http_node_1, core_contracts_1, utils_1, BluebirdPromise, busboy, compression, bodyParser, cookieParser, helmet, debug, http, cors) {
    "use strict";
